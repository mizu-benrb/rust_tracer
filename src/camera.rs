...
impl Camera {
    ...
    pub fn render(&mut self, world: &dyn Hittable) {
        ...
        image_buffer.par_chunks_mut(image_width as usize).enumerate()
            .for_each_init(|| Xoshiro256PlusPlus::from_rng(&mut rand::rng()), |rng, (y, row)| {

           for x in 0..image_width {
               let mut pixel_color = Color::new(0.0, 0.0, 0.0);
               for _s in 0..self.samples_per_pixel {
                   let r = self.get_ray(x, y as u32, rng);
    ...
    fn get_ray(&self, i: u32, j: u32, rng: &mut Xoshiro256PlusPlus) -> Ray {
    ...
    fn ray_color(&self, r: &Ray, depth: u32, world: &dyn Hittable, rng: &mut Xoshiro256PlusPlus) -> Color {
        if depth <= 0 {
